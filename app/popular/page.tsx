...
export default function PopularPage() {
  ...
  useEffect(() => {
    const loadInitialAssets = async () => {
      ...
      const sortedAssets = allAssets.sort((a, b) => (b.download_count || 0) - (a.download_count || 0));
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Most <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Downloaded</span>
        </h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          All-time favorites! These assets have been downloaded thousands of times.
        </p>
      </div>
